          ...
          <div className="relative z-10">
            ...
            <header className="mb-10 text-center relative">
                ...
                {isAdmin && currentPoem.stableId !== 'empty' && (
                  <div className="flex justify-center flex-wrap gap-2 mb-6 bg-slate-100 dark:bg-slate-800/50 p-2 rounded-2xl animate-in fade-in">
                    <button onClick={() => movePoemUp(currentPoem.stableId)} disabled={currentSortedIndex <= 0} className="p-2 text-slate-500 hover:text-indigo-500 disabled:opacity-30 transition-colors" title="Move Up"><ChevronUp size={18} /></button>
                    <button onClick={() => movePoemDown(currentPoem.stableId)} disabled={currentSortedIndex >= sortedPoems.length - 1} className="p-2 text-slate-500 hover:text-indigo-500 disabled:opacity-30 transition-colors" title="Move Down"><ChevronDown size={18} /></button>
                    <div className="w-px h-6 bg-slate-300 dark:bg-slate-700 mx-2 self-center" />
                    <button onClick={() => handleEditClick(currentPoem)} className="p-2 text-slate-500 hover:text-blue-500 transition-colors" title="Edit Poem"><Edit size={18} /></button>
                    <button onClick={() => setPoemToDelete(currentPoem.stableId)} className="p-2 text-slate-500 hover:text-red-500 transition-colors" title="Delete Poem"><Trash2 size={18} /></button>
                  </div>
                )}
...
export default App;  messagingSenderId: "864665992583",
  appId: "1:864665992583:web:e24325b595fc791a7e2722",
  measurementId: "G-QD896X6NE7"
};
