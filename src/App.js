...
const INITIAL_POEMS = [
  {
    ...
    glossary: [
      ...
      { word: "अश्क", roman: "Ashk", meaning: "Tears" },
      { word: "गुंजल", roman: "Gunjal", meaning: "Tangle / Knot" }
    ]
  },
  {
    title: "आदत",
    ...
    glossary: [
      ...
      { word: "मकबरे", roman: "Maqbare", meaning: "Tomb" },
      { word: "बेखुदी", roman: "Bekhudi", meaning: "Self-oblivion / Trance" },
      { word: "तस्सव्वुर", roman: "Tassavvur", meaning: "Imagination / Thought" },
      { word: "लज्जतें", roman: "Lazzatein", meaning: "Pleasures" }
    ]
  },
  {
    title: "धीरे धीरे",
  ...
  },
  {
    ...
    glossary: [
      ...
      { word: "हस्ती", roman: "Hasti", meaning: "Existence / Being" },
      { word: "दस्तक", roman: "Dastak", meaning: "Knock" },
      { word: "सदा", roman: "Sada", meaning: "Call / Voice" },
      { word: "शोरिशे-गेती", roman: "Shorishe-geti", meaning: "Tumult of the world" }
    ]
  },
  {
    title: "जागीर",
  ...
  },
  {
    ...
    glossary: [
      ...
      { word: "वाजिब", roman: "Wajib", meaning: "Reasonable / Proper" },
      { word: "नावाजिब", roman: "Nawajib", meaning: "Unreasonable / Improper" }
    ]
  },
  {
    title: "ख्वाब",
  ...
  },
  {
    ...
    glossary: [
      ...
      { word: "निशब्द", roman: "Nishabd", meaning: "Speechless / Without words" },
      { word: "रंजिशें", roman: "Ranjishein", meaning: "Grievances / Enmities" },
      { word: "माज़ी", roman: "Maazi", meaning: "Past" },
      { word: "जुर्रत", roman: "Jurrat", meaning: "Daring / Audacity" }
    ]
  },
  {
    title: "उम्मीद",
    ...
    glossary: [
      ...
      { word: "कंजेलब", roman: "Kunj-e-lab", meaning: "Corner of the lips" },
      { word: "जुम्बिश", roman: "Jumbish", meaning: "Movement / Stirring" },
      { word: "हस्ती", roman: "Hasti", meaning: "Existence" }
    ]
  },
  {
    title: "ज़िंदा",
  ...
  },
  {
    ...
    glossary: [
      ...
      { word: "तलबगार", roman: "Talabgaar", meaning: "Seeker / Desirous" }
    ]
  },
  {
    title: "रावण",
  ...
  },
  {
    ...
    glossary: [
      ...
      { word: "अक्स", roman: "Aks", meaning: "Reflection" }
    ]
  },
  {
    ...
    glossary: [
      ...
      { word: "कतरा", roman: "Katra", meaning: "Drop" },
      { word: "मद्धम", roman: "Maddham", meaning: "Faint / Dim" }
    ]
  },
  {
    title: "ज़िन्दगी",
  ...
  },
  {
    ...
    glossary: [
      ...
      { word: "गमे-ज़िंदगी", roman: "Gham-e-zindagi", meaning: "Sorrow of life" }
    ]
  },
  {
    ...
    glossary: [
      ...
      { word: "जुस्तजू", roman: "Justajoo", meaning: "Quest / Search" }
    ]
  },
  {
    title: "ज़्यादा",
  ...
  },
  {
    ...
    glossary: [
      ...
      { word: "मज़ार", roman: "Mazar", meaning: "Shrine / Tomb" }
    ]
  },
  {
    ...
    glossary: [
      ...
      { word: "रक्स", roman: "Raqs", meaning: "Dance" }
    ]
  },
  {
    title: "शायरी",
    ...
    glossary: [
      ...
      { word: "शौक़-ए-बेकार", roman: "Shauq-e-bekaar", meaning: "Useless hobby" },
      { word: "इलाजे-दर्दे-दुनिया", roman: "Ilaaj-e-dard-e-duniya", meaning: "Cure for the world's pain" }
    ]
  },
  {
    title: "हालत",
  ...
  },
  {
    ...
    glossary: [
      ...
      { word: "करामात", roman: "Karamaat", meaning: "Miracle" }
    ]
  },
  {
    title: "उसने कहा था",
  ...
  },
  {
    ...
    glossary: [
      ...
      { word: "गिला", roman: "Gila", meaning: "Complaint / Grievance" },
      { word: "सिला", roman: "Sila", meaning: "Reward / Return" }
    ]
  },
  {
    title: "मुजरिम",
  ...
  },
  {
    ...
    glossary: [
      ...
      { word: "फ़रियाद", roman: "Fariyaad", meaning: "Plea / Request" }
    ]
  },
  {
    title: "फिर वही मोड़",
...
const App = () => {
    ...
    const initAuth = async () => {
      try {
        ...
        if (error.code === 'auth/admin-restricted-operation' || error.code === 'auth/operation-not-allowed') {
           console.warn("Firebase Anonymous Auth is disabled.");
        } else {
  ...
  useEffect(() => {
    ...
    const unsubRatings = onSnapshot(ratingsRef, (snapshot) => {
      ...
      snapshot.docs.forEach(docSnap => {
        ...
        if (!currentUserRating && localRatings[poemId]) {
            currentUserRating = localRatings[poemId];
  ...
  const movePoemDown = async (stableId) => {
    if (!db) return;
    const idx = sortedPoems.findIndex(p => p.stableId === stableId);
    if (idx === -1 || idx >= sortedPoems.length - 1) return;
  ...
  const handleAdminSubmit = () => {
    if (adminPassInput === 'sandeep') {
      ...
      setAdminPassError('Incorrect password');
    }
  };
  ...
  const shareUrl = typeof window !== 'undefined' ? `${window.location.origin}${window.location.pathname}?poem=${selectedPoemId}` : '';
    ...
    <div className={`min-h-screen transition-colors duration-500 ${darkMode ? 'dark bg-slate-900 text-slate-100' : 'bg-slate-50 text-slate-900'}`}>
      ...
      <header className="lg:hidden sticky top-0 z-30 flex items-center justify-between p-4 bg-slate-50/90 dark:bg-slate-900/90 border-b border-slate-200 dark:border-slate-800 backdrop-blur-md">
        ...
        <div className="flex gap-2">
          <button onClick={() => isAdmin ? handleAdminLogout() : setShowAdminModal(true)} className="p-2 hover:bg-slate-200 dark:hover:bg-slate-800 rounded-lg text-slate-500" title={isAdmin ? "Exit Admin" : "Admin Login"}>
            {isAdmin ? <Unlock size={20} /> : <Lock size={20} />}
          </button>
          <button onClick={() => setDarkMode(!darkMode)} className="p-2 hover:bg-slate-200 dark:hover:bg-slate-800 rounded-lg text-slate-500">
      ...
      <main className="lg:ml-80 min-h-screen flex flex-col items-center p-4 lg:p-12 transition-all">
        <div className="hidden lg:flex w-full max-w-2xl justify-end mb-6 gap-3">
          <button onClick={() => isAdmin ? handleAdminLogout() : setShowAdminModal(true)} className="flex items-center gap-2 px-4 py-2 bg-white dark:bg-slate-800 shadow-sm border border-slate-200 dark:border-slate-700 rounded-full hover:scale-105 transition-transform text-slate-500 text-sm font-bold">
            {isAdmin ? <Unlock size={16} /> : <Lock size={16} />}
            {isAdmin ? "Exit Admin" : "Admin"}
          </button>
          <button onClick={() => setDarkMode(!darkMode)} className="p-2.5 bg-white dark:bg-slate-800 shadow-sm border border-slate-200 dark:border-slate-700 rounded-full hover:scale-110 transition-transform text-slate-500">
            {darkMode ? <Sun size={20} /> : <Moon size={20} />}
          </button>
        </div>
          ...
          <div className="relative z-10 w-full h-full flex flex-col">
            ...
            <header className="mb-10 text-center relative">
                ...
                <div className="flex justify-center items-start flex-wrap gap-4 sm:gap-8 mb-8">
                    ...
                    {/* Share */}
                    <button onClick={() => setIsShareModalOpen(true)} className="flex flex-col items-center group gap-1.5" title="Share Poem">
                      <div className="transition-all flex items-center justify-center h-8 text-slate-300 group-hover:text-green-500">
                        <Share2 size={22} />
                      </div>
                      <span className="text-[10px] font-medium text-slate-400 dark:text-slate-500">Share</span>
                    </button>

                    {/* Record / Stop (Admin) */}
                    {isAdmin && (
                      <button onClick={isRecording ? stopRecording : startRecording} className="flex flex-col items-center group gap-1.5" title={isRecording ? "Stop Recording" : "Record Voice"}>
                        ...
                        <span className={`text-[10px] font-medium ${isRecording ? 'text-red-500 font-bold font-mono tracking-widest' : 'text-slate-400 dark:text-slate-500'}`}>
            ...
            {currentMedia && !isRecording && (
                <div className="mb-12 relative w-full max-w-lg mx-auto p-[2px] bg-gradient-to-tr from-slate-200 via-white to-slate-200 dark:from-slate-700 dark:via-slate-800 dark:to-slate-700 rounded-[2rem] shadow-xl hover:shadow-2xl transition-shadow duration-500 animate-in fade-in zoom-in-95">
                    <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl p-5 sm:p-6 rounded-[1.9rem] flex flex-col gap-5">
                        
                        {/* Header: Branding & Play Button */}
                        <div className="flex items-center justify-between gap-4">
                            <div className="flex items-center gap-3 sm:gap-4 flex-1">
                                <div className="flex flex-col text-left justify-center">
                                    <span className="text-[10px] font-bold text-slate-400 tracking-widest uppercase mb-1">Recited By</span>
                                    <span className="text-sm sm:text-lg font-bold text-slate-800 dark:text-slate-100 leading-none font-sans">Sandeep Dhingra</span>
                                </div>
                            </div>

                            {/* Large Play/Pause Button */}
                            <button onClick={togglePlayPause} className="w-14 h-14 sm:w-16 sm:h-16 flex-shrink-0 flex items-center justify-center bg-red-600 text-white rounded-full shadow-lg shadow-red-600/30 hover:bg-red-700 hover:scale-105 active:scale-95 transition-all">
                                {isPlaying ? <Pause fill="currentColor" size={24} /> : <Play fill="currentColor" size={28} className="ml-1" />}
                            </button>
                        </div>
                        ...
                        {currentMedia.type !== 'video' && (
                          <div className="flex items-center gap-3 w-full">
                              <span className="text-[10px] font-medium text-slate-400 font-mono w-8 text-right">{formatTime(progress)}</span>
                              <input 
                                  type="range" 
                                  min={0} 
                                  max={duration || 100} 
                                  ...
                                  className="flex-1 h-1.5 bg-slate-200 dark:bg-slate-700 rounded-full appearance-none cursor-pointer accent-red-500"
                              />
                              <span className="text-[10px] font-medium text-slate-400 font-mono w-8 text-left">{formatTime(duration)}</span>
                          </div>
                        )}
                        ...
                        {currentMedia.type === 'video' ? (
                          <video 
                            ...
                            controls={false} // Hidden controls, handled by our UI
                          />
                        ) : (
                          <audio 
                            ref={audioRef}
                        ...
                        {/* Utility Footer */}
                        <div className="flex justify-between items-center pt-4 border-t border-slate-100 dark:border-slate-800/60 mt-1">
                            <span className="text-[9px] text-slate-400 flex items-center gap-1 uppercase tracking-widest font-bold">
                                <Cloud size={10} className="text-blue-400" /> {currentMedia.label} Backup
                            </span>
                            <div className="flex items-center gap-3">
                              {/* Left the download handling functions as you requested */}
                              {isAdmin && (
            ...
            {currentPoem.glossary && currentPoem.glossary.length > 0 && (
              <div className="mt-8 p-6 md:p-8 bg-amber-50/50 dark:bg-amber-900/10 border border-amber-100/50 dark:border-amber-800/20 rounded-3xl text-left relative z-20">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {currentPoem.glossary.map((item, i) => (
                    <div key={i} className="flex flex-col p-3 bg-white/50 dark:bg-slate-800/50 rounded-xl border border-amber-50 dark:border-slate-700/50">
            ...
            <footer className="mt-20 pt-8 border-t border-slate-100 dark:border-slate-700 text-center text-slate-400 italic text-sm mt-auto">
        ...
        <div className="fixed inset-0 z-[130] bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 w-full max-w-sm rounded-3xl shadow-2xl p-6 text-center animate-in fade-in zoom-in-95 duration-200">
             <div className="flex justify-between items-center mb-4">
                 <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100">Share Poem</h3>
                 <button onClick={() => setIsShareModalOpen(false)} className="text-slate-400 hover:text-red-500 transition-colors"><X size={20} /></button>
             </div>
             <p className="text-slate-500 dark:text-slate-400 mb-6 text-sm">Share "{displayTitle}" with your friends.</p>

             <div className="flex items-center gap-2 bg-slate-50 dark:bg-slate-900 p-2 rounded-xl border border-slate-200 dark:border-slate-700 mb-6 overflow-hidden">
                 <input type="text" readOnly value={shareUrl} className="bg-transparent outline-none text-xs text-slate-500 flex-1 px-2 select-all whitespace-nowrap" />
                 <button onClick={handleCopyLink} className="p-2 bg-slate-200 dark:bg-slate-700 rounded-lg hover:bg-slate-300 dark:hover:bg-slate-600 transition-colors text-slate-600 dark:text-slate-300 flex-shrink-0" title="Copy Link">
                     {isCopied ? <Check size={16} className="text-green-500" /> : <Copy size={16} />}
                 </button>
             </div>

             <div className="grid grid-cols-3 gap-3">
                 <button onClick={() => window.open(`https://api.whatsapp.com/send?text=${encodeURIComponent('Read "' + displayTitle + '" by Sandeep Dhingra on Mera Sach:\n' + shareUrl)}`, '_blank')} className="flex flex-col items-center gap-2 p-3 bg-green-50 dark:bg-green-900/20 text-green-600 dark:text-green-400 rounded-2xl hover:bg-green-100 dark:hover:bg-green-900/40 transition-colors">
                     <MessageCircle size={24} />
                     <span className="text-[10px] font-bold uppercase tracking-wider">WhatsApp</span>
                 </button>
                 <button onClick={() => window.open(`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(shareUrl)}`, '_blank')} className="flex flex-col items-center gap-2 p-3 bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 rounded-2xl hover:bg-blue-100 dark:hover:bg-blue-900/40 transition-colors">
                     <Facebook size={24} />
                     <span className="text-[10px] font-bold uppercase tracking-wider">Facebook</span>
                 </button>
                 <button onClick={() => window.open(`https://twitter.com/intent/tweet?text=${encodeURIComponent('Read "' + displayTitle + '" by Sandeep Dhingra')}&url=${encodeURIComponent(shareUrl)}`, '_blank')} className="flex flex-col items-center gap-2 p-3 bg-sky-50 dark:bg-sky-900/20 text-sky-600 dark:text-sky-400 rounded-2xl hover:bg-sky-100 dark:hover:bg-sky-900/40 transition-colors">
                     <Twitter size={24} />
      ...
      {showAdminModal && (
        <div className="fixed inset-0 z-[120] bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white dark:bg-slate-800 w-full max-w-sm rounded-3xl shadow-2xl p-6 text-center animate-in fade-in zoom-in-95 duration-200">
            <div className="w-16 h-16 bg-slate-100 dark:bg-slate-700 text-slate-500 rounded-full flex items-center justify-center mx-auto mb-4">
              <Lock size={32} />
            </div>
            <h3 className="text-xl font-bold text-slate-800 dark:text-slate-100 mb-2">Admin Access</h3>
            <p className="text-slate-500 dark:text-slate-400 mb-6 text-sm">Enter password to manage poems and audio.</p>
            ...
            <input 
              ...
              className="w-full p-3 mb-2 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-red-400 outline-none text-center"
              placeholder="Password"
            />
            {adminPassError && <p className="text-red-500 text-xs mb-4">{adminPassError}</p>}
            {!adminPassError && <div className="h-4 mb-4"></div>}

            <div className="flex gap-3 justify-center">
              <button onClick={() => {setShowAdminModal(false); setAdminPassError(''); setAdminPassInput('');}} className="px-6 py-3 rounded-xl text-slate-600 dark:text-slate-300 font-bold bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors w-1/2">Cancel</button>
              <button onClick={handleAdminSubmit} className="px-6 py-3 rounded-xl bg-red-600 text-white font-bold shadow-lg shadow-red-200 dark:shadow-none hover:bg-red-700 transition-colors w-1/2">Unlock</button>
            </div>
          </div>
        </div>
      )}
