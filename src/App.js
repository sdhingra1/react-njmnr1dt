...
const App = () => {
  ...
  useEffect(() => {
    ...
    // Retain admin state if previously logged in locally
    if (localStorage.getItem('mera_sach_admin') === 'true') {
      setIsAdmin(true);
    }
  }, []);
      ...
      <main className="lg:ml-80 min-h-screen flex flex-col items-center p-4 lg:p-12 transition-all">
        ...
        <article className="max-w-3xl w-full bg-white dark:bg-slate-800/40 p-8 lg:p-16 rounded-[2.5rem] shadow-2xl border border-slate-100 dark:border-slate-800 relative overflow-hidden group">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-0 overflow-hidden rounded-[2.5rem]">
            <img 
              src="/image_329045.jpg" 
              alt="Author Background" 
              className="absolute w-full h-full object-cover object-top mix-blend-multiply dark:mix-blend-screen"
              style={{ 
                    ...
                    <div className="bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl p-5 sm:p-6 rounded-[1.9rem] flex flex-col gap-5">
                        ...
                        <div className="flex items-center justify-between gap-4">
                            <div className="flex items-center gap-3 sm:gap-4 flex-1">
                                {/* The Subtle but Effective Branding: Artist Avatar */}
                                <div className="relative w-12 h-12 sm:w-16 sm:h-16 rounded-full p-[2px] bg-gradient-to-tr from-red-400 to-indigo-500 shadow-md flex-shrink-0">
                                    <img 
                                      src="/image_329045.jpg" 
                                      alt="Sandeep Dhingra" 
                                      className="w-full h-full object-cover object-top rounded-full border-2 border-white dark:border-slate-900 filter contrast-110" 
                                    />
                                </div>
